...
member responsible for EfficientNetV2. Do not edit other models' folders.
"""
import torch
...
from models.efficientnetv2.model import get_model, freeze_backbone, unfreeze_last_blocks


def main():
    cfg = load_config("configs/efficientnetv2.yaml")
    set_seed(cfg["seed"])
    device = get_device()
    ...
    train_model(
        ...
        model_name="efficientnetv2_phase1_warmup",
    )
